...
// Import the real pages we've created
...
const EducationPage = () => <PlaceholderPage title="Education" />;
const ProfilePage = () => <PlaceholderPage title="Profile" />;
const StorePage = () => <PlaceholderPage title="Store" />;
const EventDetailsPage = () => <PlaceholderPage title="Event Details" />;
const ScheduleItemDetailsPage = () => <PlaceholderPage title="Schedule Item Details" />;
const UniversityDetailsPage = () => <PlaceholderPage title="University Details" />;
const CourseDetailsPage = () => <PlaceholderPage title="Course Details" />;
...
export const AppRoutes: React.FC<{ isApplicant: boolean }> = ({ isApplicant }) => {
  return (
    <>
      <main className={`flex-grow pb-24 ${isApplicant ? 'blur-sm pointer-events-none' : ''}`}>
        <Routes>
          ...
          <Route path="/schedule/:id" element={<ScheduleItemDetailsPage />} />
      ...
      <nav className={`fixed bottom-0 left-0 right-0 h-20 bg-white/80 dark:bg-neutral-900/80 backdrop-blur-lg border-t border-neutral-200 dark:border-neutral-800 flex items-center justify-around shadow-t-2xl ${isApplicant ? 'blur-sm pointer-events-none' : ''}`}>
